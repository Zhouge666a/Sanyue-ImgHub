  ...
  <div class="public-browse">
    ...
    <div v-else-if="error" class="error-container">
      ...
      <div class="error-credit">
        ...
        <div class="error-credit-links">
          <a href="https://pan.2026gu.com/browse" target="_blank" rel="noopener">
    ...
    <div v-else class="gallery-container" ref="galleryContainer">
      ...
      <div ref="loadTrigger" class="load-trigger">
        ...
        <a v-if="!hasMore && mediaFiles.length > 0" class="credit-link" href="https://pan.2026gu.com/" target="_blank" rel="noopener">
          zhoupans
